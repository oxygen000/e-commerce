...
<div
              ...
              >
                ...
                {/* Content */}
                <div className="p-4">
                  <div className="text-xs text-gray-500 mb-1">{product.category?.name || "Unknown"}</div>
                  ...
                  <div className="flex items-center mb-2">
                    <div className="flex text-yellow-400 mr-2">
                      {[1, 2, 3, 4, 5].map((star) =>
                        star <= Math.round(product.ratingsAverage || 0) ? <FaStar key={star} /> : <FaRegStar key={star} />,
                      )}
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-lg font-bold text-gray-800">{product.priceAfterDiscount || product.price} EGP</span>
